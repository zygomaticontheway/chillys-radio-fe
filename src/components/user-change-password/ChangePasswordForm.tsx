...
const PasswordChangeForm: React.FC<PasswordChangeFormProps> = ({ userId, isAdmin }) => {
    ...
    const { isLoading, success, error } = useSelector((state: RootState) => state.userPassword);
...
return (
    <div className="password-form-container">
        ...
        {success && <p className="success-msg"> Password successfully changed !</p> }
